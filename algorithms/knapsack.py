...
"""
    knapsack.py
    ~~~~~~~~~~~~
    Contains algorithms for determining max value of Knapsack Problem:
        knapsack_naive: computes all subproblems
        knapsack_smart: computes only necessary subproblems
